    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downstream', models.ManyToManyField(related_name='pipelinetemplate_downstream', to='pipelines.Pipeline')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downstream', models.ManyToManyField(related_name='tasktemplate_downstream', to='pipelines.Task')),
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='projects.Project')),
                ('status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='pipelines.Status')),
                ('upstream', models.ManyToManyField(related_name='tasktemplate_upstream', to='pipelines.Task')),
            ],
        ),
        migrations.CreateModel(
            name='Workflow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downstream', models.ManyToManyField(related_name='workflowtemplate_downstream', to='pipelines.Workflow')),
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='projects.Project')),
                ('status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='pipelines.Status')),
                ('upstream', models.ManyToManyField(related_name='workflowtemplate_upstream', to='pipelines.Workflow')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='pipelinetemplate',
            name='upstream',
            field=models.ManyToManyField(related_name='pipelinetemplate_upstream', to='pipelines.Pipeline'),
        ),
        migrations.AddField(
            model_name='pipelinetemplate',
            name='workflows',
